...
describe("Vampire", function () {
  ...
  describe("closestCommonAncestor", function () {
    ...
    it("should be the root vampire for any vampire and the root vampire", () => {
      // console.log(offspring2.parentsList(offspring2));
      // console.log(rootVampire.closestCommonAncestor(offspring2).name);
    ...
    it("should be offspring 3 for offspring 4 and 7", () => {
      // console.log(offspring4, offspring7);
      // console.log(offspring7.parentsList(offspring7));
      // console.log(offspring4.closestCommonAncestor(offspring7).name);
